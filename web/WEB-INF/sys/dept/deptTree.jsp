...
<script type="text/javascript">
          ...
          //d.add('U_<s:property value="rootUnitNo"/>','-1','&nbsp;<B>校讯通手机服务端单位机构</B>','dept_list.do?orgNo=<s:property value="rootUnitNo"/>','','deptInfoFrame');
		  <s:iterator id="var" value="orgList" status="vStatus">
		  	d.add('U_<s:property value="#var.orgNo"/>','<s:property value="#var.porgNo==rootUnitNo?-1:'U_'+#var.porgNo"/>','<s:property value="#var.orgName"/>',
      			'dept_list.do?orgNo=<s:property value="#var.orgNo"/>','','deptInfoFrame',
      		...
      		<s:if test="#var.orgNo==#var2.orgNo">
      			<s:if test="#var2.pdeptNo!=null && #var2.pdeptNo!=''">
      				...
      				'dept_list.do?orgNo=<s:property value="#var2.orgNo"/>&pdeptNo=<s:property value="#var2.id"/>','','deptInfoFrame',
