...
<fieldset class="VForm">
    ...
    <div class="Single">
      <label>产品图片：</label><img src="<s:property value="image"/>" width="200px" /><s:file id="images" name="images" cssStyle="width:200px;"></s:file>
      <span style="color:Red">
      <s:fielderror>
    ...
    <div class="Single">
      <label>详细产品图片：</label><img src="<s:property value="introimg"/>" width="200px" /><s:file id="introimgs" name="introimgs" cssStyle="width:200px;"></s:file>
      <span style="color:Red">
      <s:fielderror>
      <s:param>introimg</s:param>
      </s:fielderror>
      </span>
    </div>
