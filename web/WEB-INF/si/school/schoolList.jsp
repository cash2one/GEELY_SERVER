...
function deleteInfo() {
    ...
    $.messager.confirm('确定操作', '你确定要删除选中的数据?', function(r){
		...
		var a = "";
			...
			location = "school_delschool.do?id="+a+"&pageNo=<s:property value="pageNo"/>";
		}
	});
}
...
function editpro(){
    ...
    if(v.length > 1){
     ...
     var url ="school_edischool.do?id="+v[0];
     window.location=url;
}
...
<div class="searchPanel" style="margin-left:12px;">
    ...
    <div class="searchPanel-body">
    	  省:<select id="sprovince" name="sprovince">  
            <option value="">请选择</option>  
            </select> 
           市:<select id="scity" name="scity">  
            <option value="">请选择</option>  
            </select> 
           区:<select id="stown" name="stown">  
            <option value="">请选择</option>  
            </select>
	...
	<thead>
	  <tr>
        	<td colspan="10">
				...
				<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="location='school_addSchool.do'">新增学校信息</a> 
				<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-edit" onclick="editpro()">学校信息修改</a> 				
				<a href="#" class="easyui-linkbutton" id="bt_delete"  onclick="deleteInfo()" class="easyui-linkbutton" plain="true" iconCls="icon-cancel">学校信息删除</a>
				<a href="#" class="easyui-linkbutton" plain="true" iconCls="icon-reload" onclick="classinfo()">学校班级信息</a> 
				</div>
        	</td>
      </tr>
    </thead>
...
<table class="infoList" cellspacing="1" cellpadding="0" rules="all" border="0" id="grid1" style="width:98%;" align="center">
	<thead>
	  <tr>
	    <th scope="col"></th>
		<th scope="col">学校名字</th>
		<th scope="col">学校所在市</th>
		<th scpoe="col">学校所在区</th>
	  </tr>
	  </thead>
	  <tbody>
	  ...
	  <s:iterator id="var" value="list" status="vStatus">
	   <tr class="<s:if test="#vStatus.count%2==1">trBg01</s:if><s:else>trBg02</s:else>" onclick="RowMouseClick(this,&quot;grid1_<s:property value="#vStatus.count"/>_CheckBoxButton&quot;);">
	    ...
	    <td align="center"><s:property value="#var.area.area"/> </td>
	    <td align="center"><s:property value="#var.town.town"/> </td>
