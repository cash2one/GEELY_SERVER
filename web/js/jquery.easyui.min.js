...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"当前为 {from} 到 {to} 共 {total} 条记录"};
})(jQuery);
(function($){
function _7c(_7d){
var _7e=$(_7d);
...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"必填字段。",invalidMessage:null,rules:{email:{validator:function(_2a4){
...
},message:"请输入正确的Email地址。"},url:{validator:function(_2a5){
...
},message:"请输入正确的URL地址。"},length:{validator:function(_2a6,_2a7){
var len=$.trim(_2a6).length;
return len>=_2a7[0]&&len<=_2a7[1];
},message:"请输入值的范围是 {0} 至 {1}。"}}};
})(jQuery);
(function($){
